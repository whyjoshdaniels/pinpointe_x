export default function Head() {
  return (
    <div>
        ...
        <link key="dropdown" rel="stylesheet" href="assets/dropdown/css/style.css" />
        <link key="socicon" rel="stylesheet" href="assets/socicon/css/styles.css" />
        <link key="theme" rel="stylesheet" href="assets/theme/css/style.css" />
        <title key="title">Pinpointe Data Solutions</title>
    </div>
  );
}
